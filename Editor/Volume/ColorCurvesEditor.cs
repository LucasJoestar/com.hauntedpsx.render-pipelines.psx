...
using CurveState = UnityEditor.Rendering.InspectorCurveEditor.CurveState;
using System.Collections.Generic;

namespace HauntedPSX.RenderPipelines.PSX.Editor
{
    [VolumeComponentEditor(typeof(ColorCurvesVolume))]
    sealed class ColorCurvesEditor : VolumeComponentEditor
    {
        ...
        {
            var o = new PropertyFetcher<ColorCurvesVolume>(serializedObject);
        ...
        void DrawBackgroundTexture(Rect rect, int pass)
        {
            if (s_MaterialGrid == null)
                s_MaterialGrid = new Material(Shader.Find("Hidden/HauntedPSX/Editor/CurveBackground")) { hideFlags = HideFlags.HideAndDontSave };
        ...
        {
            var t = target as ColorCurvesVolume;
